...
//        //Load data to Combobox Product
//        ProductDAO productDAO = new ProductDAO();
//        ObservableList<Product> products = (ObservableList<Product>) productDAO.getList();
//        comboboxProductID.setItems(products);
//        comboboxProductID.getSelectionModel().select(1);
//        comboboxProductID.setConverter(new StringConverter<Product>() {
//            @Override
...
//            @Override
//            public Product fromString(String s) {
//                return comboboxProductID.getItems().stream().filter(product -> product.getPName().equals(s)).findFirst().orElse(null);
//            }
//        });
//
//
...
//}
//
>>>>>>> 19bd394e7af11cb3bde29f621a6da7f846268476
